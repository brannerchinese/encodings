...
\begin{frame}[fragile]
  ...
  Python 2.7 assumes all strings are ASCII, but this is sometimes concealed from me because the Ipython interpreter tries to convert silently to known encodings (here, utf-8):
